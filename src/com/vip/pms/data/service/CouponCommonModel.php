...
class CouponCommonModel {
	...
	public function __construct($vals=null){
		...
		if (is_array($vals)){
			...
			if (isset($vals['isBindGoods'])){
				
				$this->isBindGoods = $vals['isBindGoods'];
			}
	...
	public function read($input){
		...
		while(true){
			...
			if ("isBindGoods" == $schemeField){
				
				$needSkip = false;
				$input->readByte($this->isBindGoods); 
	...
	public function write($output){
		...
		if($this->isBindGoods !== null) {
			
			$xfer += $output->writeFieldBegin('isBindGoods');
			$xfer += $output->writeByte($this->isBindGoods);
