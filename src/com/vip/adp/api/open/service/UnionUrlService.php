...
namespace VipClient\com\vip\adp\api\open\service;
interface UnionUrlServiceIf{
	...
	public function genByVIPUrl( $urlList, $chanTag, $requestId, $statParam,\VipClient\com\vip\adp\api\open\service\UrlGenRequest $urlGenRequest);
	
	public function genByVIPUrlWithOauth( $urlList, $chanTag, $requestId, $statParam,\VipClient\com\vip\adp\api\open\service\UrlGenRequest $urlGenRequest);
	
	public function getWxCode(\VipClient\com\vip\adp\api\open\service\WxCodeGenRequest $request);
	
	public function getWxCodeWithOauth(\VipClient\com\vip\adp\api\open\service\WxCodeGenRequest $request);
	
	public function healthCheck();
	
	public function vipLinkCheck(\VipClient\com\vip\adp\api\open\service\VipLinkCheckReq $vipLinkCheckReq);
	
	public function vipLinkCheckWithOuth(\VipClient\com\vip\adp\api\open\service\VipLinkCheckReq $vipLinkCheckReq);
	
}

class _UnionUrlServiceClient extends \VipClient\Osp\Base\OspStub implements \VipClient\com\vip\adp\api\open\service\UnionUrlServiceIf{
	...
	public function send_genByGoodsId( $goodsIdList, $chanTag, $requestId, $statParam){
		...
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByGoodsId_args();
	...
	public function recv_genByGoodsId(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByGoodsId_result();
	...
	public function send_genByGoodsIdWithOauth( $goodsIdList, $chanTag, $requestId, $statParam){
		...
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByGoodsIdWithOauth_args();
	...
	public function recv_genByGoodsIdWithOauth(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByGoodsIdWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_genByVIPUrl( $urlList, $chanTag, $requestId, $statParam,\VipClient\com\vip\adp\api\open\service\UrlGenRequest $urlGenRequest){
		
		$this->initInvocation("genByVIPUrl");
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByVIPUrl_args();
	...
	public function recv_genByVIPUrl(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByVIPUrl_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_genByVIPUrlWithOauth( $urlList, $chanTag, $requestId, $statParam,\VipClient\com\vip\adp\api\open\service\UrlGenRequest $urlGenRequest){
		
		$this->initInvocation("genByVIPUrlWithOauth");
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByVIPUrlWithOauth_args();
	...
	public function recv_genByVIPUrlWithOauth(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_genByVIPUrlWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_getWxCode(\VipClient\com\vip\adp\api\open\service\WxCodeGenRequest $request){
		
		$this->initInvocation("getWxCode");
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_getWxCode_args();
	...
	public function recv_getWxCode(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_getWxCode_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_getWxCodeWithOauth(\VipClient\com\vip\adp\api\open\service\WxCodeGenRequest $request){
		
		$this->initInvocation("getWxCodeWithOauth");
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_getWxCodeWithOauth_args();
	...
	public function recv_getWxCodeWithOauth(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_getWxCodeWithOauth_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_healthCheck(){
		...
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_healthCheck_args();
	...
	public function recv_healthCheck(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_healthCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_vipLinkCheck(\VipClient\com\vip\adp\api\open\service\VipLinkCheckReq $vipLinkCheckReq){
		
		$this->initInvocation("vipLinkCheck");
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_vipLinkCheck_args();
	...
	public function recv_vipLinkCheck(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_vipLinkCheck_result();
		$this->receive_base($result);
		if ($result->success !== null){
	...
	public function send_vipLinkCheckWithOuth(\VipClient\com\vip\adp\api\open\service\VipLinkCheckReq $vipLinkCheckReq){
		
		$this->initInvocation("vipLinkCheckWithOuth");
		$args = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_vipLinkCheckWithOuth_args();
	...
	public function recv_vipLinkCheckWithOuth(){
		...
		$result = new \VipClient\com\vip\adp\api\open\service\UnionUrlService_vipLinkCheckWithOuth_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class UnionUrlService_genByGoodsId_args {
	...
	public function write($output){
		...
		if (!is_array($this->goodsIdList)){
			...
			throw new \VipClient\Osp\Exception\OspException('Bad type in structure.', \VipClient\Osp\Exception\OspException::INVALID_DATA);
		}
...
class UnionUrlService_genByVIPUrl_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->urlGenRequest = new \VipClient\com\vip\adp\api\open\service\UrlGenRequest();
...
class UnionUrlService_getWxCode_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->request = new \VipClient\com\vip\adp\api\open\service\WxCodeGenRequest();
...
class UnionUrlService_vipLinkCheck_args {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->vipLinkCheckReq = new \VipClient\com\vip\adp\api\open\service\VipLinkCheckReq();
...
class UnionUrlService_genByGoodsId_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \VipClient\com\vip\adp\api\open\service\UrlGenResponse();
...
class UnionUrlService_getWxCode_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \VipClient\com\vip\adp\api\open\service\WxCodeGenResponse();
			$this->success->read($input);
...
class UnionUrlService_healthCheck_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \VipClient\com\vip\hermes\core\health\CheckResult();
			$this->success->read($input);
...
class UnionUrlService_vipLinkCheck_result {
	...
	public function read($input){
		...
		if(true) {
			...
			$this->success = new \VipClient\com\vip\adp\api\open\service\VipLinkCheckResp();
			$this->success->read($input);
