...
interface ActivityServiceIf{
	...
	public function checkMobile( $activityId, $mobile);
...
class _ActivityServiceClient extends \Osp\Base\OspStub implements \vipapis\activity\ActivityServiceIf{
	...
	public function checkMobile( $activityId, $mobile){
		...
		$this->send_checkMobile( $activityId, $mobile);
		return $this->recv_checkMobile();
	}
	
	public function send_checkMobile( $activityId, $mobile){
		
		$this->initInvocation("checkMobile");
		$args = new \vipapis\activity\ActivityService_checkMobile_args();
	...
	public function recv_checkMobile(){
		
		$result = new \vipapis\activity\ActivityService_checkMobile_result();
		$this->receive_base($result);
		if ($result->success !== null){
...
class ActivityService_checkMobile_args {
...
class ActivityService_checkMobile_result {
