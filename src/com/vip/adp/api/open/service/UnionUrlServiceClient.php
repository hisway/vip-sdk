...
class UnionUrlServiceClient{
	...
	private static function regis(){
		...
		$path = \VipClient\Osp\Util\PathUtil::getRootPath ();
	...
	public static function getService(){
		...
		$ctx = \VipClient\Osp\Context\InvocationContextFactory::getInstance ();
		...
		return new \VipClient\com\vip\adp\api\open\service\UnionUrlServiceHelper();
	}
